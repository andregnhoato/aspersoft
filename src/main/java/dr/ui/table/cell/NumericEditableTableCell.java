...
public class NumericEditableTableCell<S extends Object, T extends Number> extends AbstractEditableTableCell<S, T> {
     ...
     */
    public NumericEditableTableCell(boolean emptyZero, boolean integerOnly, boolean completeParse ) {
        //this.format = format;
    ...
    protected String getString() {
        return getItem() == null ? "" : /*format.format(*/ getItem().toString();
    }
